...
The **Museum With No Frontiers — Gold and Silver** gallery, built from the published
dataset `@museumwnf/gold-silver-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/gold-silver-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/gold-silver/> through the reusable workflows in
