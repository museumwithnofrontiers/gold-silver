...
// `useGalleryData.js` used to be byte-identical local copies of what gold-silver
...
// legacy project key, no UUID — gold-silver shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (gold-silver-data 1.0.11+), an outside
