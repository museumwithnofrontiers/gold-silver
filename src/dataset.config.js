...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Gold and Silver',
  ...
  // one entry for every project id `npm pack @museumwnf/gold-silver-data`
  // carries in `manifest.projects` (checked 2026-09-19, gold-silver-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/gold-silver' },
