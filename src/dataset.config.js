...
export default {
  ...
  home: {
    title: 'goldSilver.identity.title',
    intro: 'goldSilver.home.intro',
    cards: [
      {
        title: 'goldSilver.nav.catalogue',
        description: 'goldSilver.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'goldSilver.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'goldSilver.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'goldSilver.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'goldSilver.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'goldSilver.partnerObjects.emptyPartner',
  //         emptyInstitution: 'goldSilver.partnerObjects.emptyInstitution',
  //         institutionSummary: 'goldSilver.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'goldSilver.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'goldSilver.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
